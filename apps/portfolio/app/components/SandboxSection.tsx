...
const sandboxes = [
  {
    ...
    description: 'Patient intake, insurance authorization, and case management, with AI-assisted case summaries.',
  ...
  },
  {
    ...
    title: 'Retirement Planning Engine',
    description: 'Year-by-year US and Canada projections with tax-aware withdrawals and a formula audit trail.',
  ...
  return (
    <section className="mt-16 sm:mt-21">
      <Reveal delay={0} className="text-center mb-[34px]">
        ...
        <p className="m-0 mx-auto text-[16px] leading-[1.6] text-ink-tertiary max-w-[46ch]">Hands-on showcases exploring modern frontend frameworks, patterns, and performance.</p>
      </Reveal>
