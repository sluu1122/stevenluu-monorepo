...
export const ACCOUNT_KIND_META: Record<AccountKind, AccountKindMeta> = {
  US_CASH_HYSA: { label: 'Cash and Cash Equivalents (US)', country: 'US', taxTreatment: 'taxable', isCashBuffer: true, defaultAvailableFromAge: null, contributionIndexRoundingStep: null },
  ...
  CA_CASH_POOL: { label: 'Cash and Cash Equivalents (CA)', country: 'CA', taxTreatment: 'taxable', isCashBuffer: true, defaultAvailableFromAge: null, contributionIndexRoundingStep: null },
